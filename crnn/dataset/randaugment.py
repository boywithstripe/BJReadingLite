...
def autocontrast_func(img, cutoff=2):
    '''
        ...
        最大图像对比度：输入一张图片，计算图片的直方图，从这个直方图中去除最亮和最暗的百分之cutoff，然后重新映射图像
        以便于保留的最暗像素变为黑色，即0，最亮变为白色为255
    '''
    n_bins = 256
...
class RandomAugment(object):
    ...
    def get_random_ops(self):
        sampled_ops = np.random.choice(list(func_dict.keys()), self.N)  # 从list(func_dict.keys())中挑选N个数
...
if __name__ == '__main__':
    ...
    imgPath = '../test_image/(18674)_1.jpg'
