...
if __name__ == "__main__":
    ...
    #   'test_dir_predict'表示根据训练时提供的test.txt文件，
    #----------------------------------------------------------------------------------------------------------#
    mode = "fps"
    #-------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "/media/deeppc/data/work_space/guo_workspace/centernet-pytorch-main/data/data_452_sf6_all/imgs/"
