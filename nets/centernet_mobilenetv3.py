...
class Header_G(nn.Module):
    def __init__(self,num_classes,mode="train"):
        super(Header_G,self).__init__()

        self.mode = mode

        #heatmaps, wh_head,reg_head
...
class MoveNet_v3(nn.Module):
    def __init__(self, num_classes=7, width_mult=1.,mode='train'):
        super(MoveNet_v3, self).__init__()

        self.backbone = Backbone()

        self.header = Header_G(num_classes, mode)
