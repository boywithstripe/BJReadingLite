...
class MobileNetV3(nn.Module):
    def __init__(self, n_class=1000, input_size=224, dropout=0.8, mode='small', width_mult=1.0):
        ...
        """
        if mode=="large":
            self.upsample = UpSample(960)
        elif mode=="small":
            self.upsample = UpSample(576)
        else:
            raise NotImplementedError
        
        self.head = Head(num_classes=n_class)
...
if __name__ == '__main__':
    model = mobilenetv3(n_class=4,mode="large").cuda()
    ...
    torch.onnx.export(model, dummy_input1, "mobilenetv3_bj_detect.onnx", 
