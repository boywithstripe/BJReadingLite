...
class PGMDet_4(nn.Module):
    def __init__(self,num_classes=1000,width_mult=1.):
        super(PGMDet_4,self).__init__()
       ...
       # self.ghost12, input_channel = ghost_s(input_channel, k[12], t[12], c[12], SE[12], s[12], width_mult)
        ...
        self.scn1 = SCN(scn_inp2,scn_inp2)
        self.scn2 = SCN(scn_inp1,scn_inp1)

        #self.scn3 = SCN(scn_inp1,scn_inp1)
...
if __name__=='__main__':
    ...
    model = PGMDet_4(num_classes=4).cuda()  # 4种热力图输出

    dummy_input1 = torch.randn(1, 3, 512, 512).cuda()
    ...
    torch.onnx.export(model, dummy_input1, "ghost_ori.onnx",
